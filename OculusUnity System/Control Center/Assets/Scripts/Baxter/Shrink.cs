...
public class Shrink : MonoBehaviour
{
    ...
    void Update()
    {
        Vector2 vals = OVRInput.Get(OVRInput.Axis2D.PrimaryThumbstick, hand.m_controller);//Give us a vector of the thumbpad direction
        float yval = vals[0];
        ...
        if (Mathf.Abs(vals[1]) < 0.2){ //Deadband
