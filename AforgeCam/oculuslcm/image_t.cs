...
namespace oculuslcm
{
    public sealed class image_t : LCM.LCM.LCMEncodable
    {
        ...
        public static readonly ulong LCM_FINGERPRINT_BASE = 0x59b1bb180d65656aL;
        ...
        {
            if (classes.Contains("oculuslcm.image_t"))
                return 0L;
 
            classes.Add("oculuslcm.image_t");
        ...
        public static oculuslcm.image_t _decodeRecursiveFactory(LCMDataInputStream ins)
        {
            oculuslcm.image_t o = new oculuslcm.image_t();
        ...
        public oculuslcm.image_t Copy()
        {
            oculuslcm.image_t outobj = new oculuslcm.image_t();
